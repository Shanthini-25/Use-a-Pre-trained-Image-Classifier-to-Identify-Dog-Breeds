...
def classify_images(images_dir, results_dic, model):
    ...
    for key, value in results_dic.items():
        # Create the image path using os.path.join
        ...
        pet_label_in_classifier = results_dic[key][0] in classifier_label

        # Add 1 if labels match, 0 otherwise
        results_dic[key].append(int(pet_label_in_classifier))
