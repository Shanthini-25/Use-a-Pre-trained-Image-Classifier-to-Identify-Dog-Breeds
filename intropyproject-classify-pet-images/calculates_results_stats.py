...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_dogs_img'] = sum(1 for key in results_dic if results_dic[key][3])
    ...
    results_stats_dic['n_correct_breed'] = sum(1 for key in results_dic if results_dic[key][3] and results_dic[key][2])
